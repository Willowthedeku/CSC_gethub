...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ((!empty($_POST['email'])) && (!empty($_POST['password']))) {
		...
		{ 
			...
			and password do not match those on file!<br>Go back and try again.</p>';
		}
		
	} 
	else { 
		print '<p class="text--error">Please make sure you enter both an
		email address and a password!<br>Go back and try again.</p>';
	}
} 
else 
{ 
